...
def sparse_random_uniform_cost_matrix_function():
    pass
...
def given_dcop_create_input():
    global A, D, dcop_name, is_neighbor_function, cost_generator_function, cost_matrix_function
    ...
    if dcop_type == DcopType.sparse_random_uniform:
        ...
        cost_matrix_function = sparse_random_uniform_cost_matrix_function
