...
selected_query_types_and_new_name = {QueryType.educated.name:"Next Best",QueryType.semi_educated.name:"Semi Educated"}

selected_algos_and_new_name = {"Complete_BNB": "Optimal"}
...
line_styles = {'Next Best': '-', "Semi Educated":'-', 'Random': '--', }
        ...
        if create_legend_image:
            if create_legend_image:
                ...
                plt.legend(handles=color_legend, title="", loc="center", frameon=False,
                           fontsize=legend_font_size, title_fontsize=legend_font_size, ncol=len(colors))  # ncol set to total items
